...
DEMO_POPUP_WIDTH = 298
DEMO_POPUP_WIDTH_LOGICAL = 149
DEMO_POPUP_INNER_WIDTH = 296
DEMO_POPUP_LINES_MAX = 6
DEMO_POPUP_LINE_STRIDE = 38
DEMO_POPUP_TEXT_MAX = 37
DEMO_POPUP_CHAR_WIDTH_LOGICAL = 4
DEMO_POPUP_TEXT_X = 2
DEMO_POPUP_TEXT_Y = 2
DEMO_POPUP_HEIGHT = 52
DEMO_POPUP_LAST_ROW = 51
DEMO_POPUP_MAX_X = 11
DEMO_POPUP_MAX_Y = 148
