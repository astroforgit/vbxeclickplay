...
; VBXE VRAM Layout
; ----------------------------------------------------------------------------
VRAM_IMG_BASE  = $8000  ; Image viewer: pixel data start (fits 320x200 @8bpp within 128KB VRAM)
ROOM_POPUP_CACHE_MEMB = $7A00     ; MEMAC B address for popup save-under scratch (VRAM $17A00)
ROOM_POPUP_CACHE_BANK = 5         ; VBXE bank containing ROOM_POPUP_CACHE_MEMB
ROOM_POPUP_CACHE_MAX  = $3C88     ; 15496 bytes reserved for popup save-under (298x52 max)
ROOM_SELECTION_CACHE_MEMB = $7688 ; MEMAC B address for cached selection patches (VRAM $1B688)
ROOM_SELECTION_CACHE_BANK = 6     ; VBXE bank containing ROOM_SELECTION_CACHE_MEMB
ROOM_SELECTION_CACHE_MAX  = $0F78 ; 3960 bytes reserved for selection-patch cache after popup scratch
